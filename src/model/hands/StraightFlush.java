...
/**
 * Represents a hand with a Straight Flush
 * 
 * @author astro_000
 *
 */
public class StraightFlush extends Hand {
	...
	/**
	 * Constructs a StraightFlush object based off of the cards given
	 * 
	 * @param cards
	 */
	 ...
	 * @param cards
	 */
	public StraightFlush(ArrayList<Card> cards, int high) {
		super(cards);
		super.setLevel(8);
		this.high = high;
	}
	...
	public int compareTo(Hand checkHand) {
		...
		if (check == 0) {
			...
			if (this.getHigh() != ((StraightFlush) checkHand).getHigh()) {
				return this.getHigh() - ((StraightFlush) checkHand).getHigh();
			}
			return 0;
		}
		/**
